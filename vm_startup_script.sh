...
echo y
IMAGE_1=us-west1-docker.pkg.dev/freightslayer-staging/backend/backend:$commit_SHA IMAGE_2=us-west1-docker.pkg.dev/freightslayer-staging/backend-nginx/nginx:$commit_SHA docker-compose up -d