...
def add_to_shipment_admin_notification_handler(sender, instance: models.ShipmentAdmin, created, **kwargs):
    if created:
        ...
        handle_notification(action="add_as_shipment_admin", app_user=instance.admin, sender=shipment.created_by)
...
def offer_notification_handler(sender, instance: models.Offer, created, **kwargs):
    if created:
        handle_notification(action="got_offer", app_user=instance.party_2, load=instance.load, sender=instance)